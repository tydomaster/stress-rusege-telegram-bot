...
Поиграть можно тут - [тык](t.me/udareniya_ege_bot) (или можно ввести в телеграм @udareniya_ege_bot) (НЕ РАБОТАЕТ В ДАННЫЙ МОМЕНТ). Или можно его установить самостоятельно, для чего и был создан этот репозиторий.
